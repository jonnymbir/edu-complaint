			...
			<div class="row">
				<div class="col-lg-8">
					<div class="card card-item">
						<form wire:submit.prevent="publish_question" class="card-body row">
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">First Name</label>
								<div class="form-group">
									<input class="form-control form--control" type="text" name="text" placeholder="e.g. John" wire:model="first_name">
								</div>
								
								@error('first_name') <span class="text-danger">{{ $message }}</span> @enderror
							</div><!-- end input-box -->
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Middle Name</label>
								<div class="form-group">
									<input class="form-control form--control" type="text" name="text" placeholder="e.g. Smith" wire:model="middle_name">
									
									@error('middle_name') <span class="text-danger">{{ $message }}</span> @enderror
								</div>
							</div><!-- end input-box -->
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Last Name</label>
								<div class="form-group">
									<input class="form-control form--control" type="text" name="text" placeholder="e.g. Doe" wire:model="last_name">
							...
							<div class="col-lg-6 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Email Address</label>
								<div class="form-group">
									<input class="form-control form--control" type="email" name="text" placeholder="e.g. johndoe@gmail.com" wire:model="email_address">
									
									@error('email_address') <span class="text-danger">{{ $message }}</span> @enderror
								</div>
							</div><!-- end input-box -->
							<div class="col-lg-6 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Telephone</label>
								<div class="form-group">
									<input class="form-control form--control" type="tel" name="text" placeholder="e.g. 23324000000" wire:model="telephone">
							...
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Sex</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select a Gender" wire:model="sex">
							...
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Stakeholder Type</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select a Stakeholder type" wire:model="stakeholder_type">
										<option selected value="">Select a Stakeholder type</option>
									...
									@error('stakeholder_type') <span class="text-danger">{{ $message }}</span> @enderror
								</div>
							</div><!-- end input-box -->
							<div class="col-lg-4 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Concern</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select a Concerns" wire:model="concern">
									...
									@error('concern') <span class="text-danger">{{ $message }}</span> @enderror
								</div>
							</div><!-- end input-box -->
							
							<div class="col-lg-6 input-box">
								<label class="fs-14 text-black fw-medium mb-0">Region</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select a Region" wire:model.lazy="region">
							...
							<div class="col-lg-6 input-box">
								<label class="fs-14 text-black fw-medium mb-0">District</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select a District" wire:model.lazy="district">
							...
							<div class="col-lg-12 input-box">
								...
								<div class="form-group">
									<textarea class="form-control form--control" rows="10" cols="40" wire:model="details"></textarea>
							...
							<div class="col-lg-12 input-box">
								<label class="fs-14 text-black fw-medium">Attachment</label>
								<div class="form-group">
									<div class="file-upload-wrap file-upload-layout-2">
										<input type="file" name="files[]" class="file-upload-input" multiple wire:model="attachments">
										<span class="file-upload-text d-flex align-items-center justify-content-center">
											<i class="la la-cloud-upload mr-2 fs-24"></i>Drop files here or click to upload.</span>
									</div>
							...
							<div class="col-lg-12 input-box">
								<label class="fs-14 text-black fw-medium mb-0">How do you want to be contacted</label>
								<div class="form-group">
									<select class="form-control form--control" data-placeholder="Select Option" wire:model="response_channel">
									...
									@error('response_channel') <span class="text-danger">{{ $message }}</span> @enderror
								</div>
							</div><!-- end input-box -->
							
							<div class="col-lg-12 input-box pt-2">
								<div class="form-group">
									<div class="custom-control custom-checkbox fs-13 mb-1">
										<input type="checkbox" class="form-check-input" id="anonymous" wire:model="is_anonymous">
										<label class="" for="anonymous">
											Do you want this anonymized
										</label>
									</div>
								</div>
								<div class="btn-box">
									<button type="submit" class="btn theme-btn" wire:loading.attr="disabled">Publish your question</button>
								</div>
{{--								<div wire:loading wire:target="publish_question"> Publishing your query... </div>--}}
							</div>
						</form>
					</div><!-- end card -->
				</div><!-- end col-lg-8 -->
								...
								<div class="card">
									<div class="card-header" id="headingThree">
										<button class="btn btn-link collapsed fs-15" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
											<span><span class="text-color pr-2 fs-16">3.</span> Show more info</span>
											<i class="la la-angle-down collapse-icon"></i>
										</button>
									</div>
									<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
										<div class="card-body">
											<p class="fs-14 lh-22 text-black-50">
												Include all the necessary information but try to keep your question concise.
											</p>
										</div>
									</div>
								</div><!-- end card -->
