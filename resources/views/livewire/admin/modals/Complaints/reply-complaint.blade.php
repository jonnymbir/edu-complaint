...
<div wire:ignore.self id="replyComplaintModal" class="modal fade" tabindex="-1" aria-labelledby="replyComplaintModal"
        ...
        <div class="modal-content">
            ...
            @if ($this->complaint)
                <div class="modal-header d-flex align-items-center">
                    <h4 class="modal-title" id="replyComplaintModalLabel">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $this->complaint->response_channel }}" disabled readonly />
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="response" rows="10" cols="20"
                                        placeholder="Provide response to this Concern" required wire:model="response"></textarea>
