...
<div wire:ignore.self id="forwardComplaintModal" class="modal fade" tabindex="-1" aria-labelledby="forwardComplaintModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
			...
			@if($this->complaint)
				...
				<form wire:submit.prevent="forwardComplaint">
					...
					<div class="modal-footer">
						<button class="btn btn-info rounded-pill px-4 mt-3" type="submit" wire:loading.remove wire:target="forwardComplaint">
							Forward Concern
						</button>
						<div wire:loading wire:target="forwardComplaint">
							<button class="btn btn-info rounded-pill px-4 mt-3" type="button" disabled>
								<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> &nbsp; Forwarding...
							</button>
						</div>
