...
<div wire:ignore.self id="viewComplaintModal" class="modal fade" tabindex="-1" aria-labelledby="viewComplaintModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
					...
					<div class="card-body">
						...
						@can('complaints.comment')
							...
							<form wire:submit.prevent="submitComment">
								...
								<button class="btn btn-info rounded-pill px-4 mt-3" type="submit" wire:loading.remove wire:target="submitComment">
									Submit Comment
								</button>
								<button class="btn btn-info rounded-pill px-4 mt-3" type="button" disabled wire:loading wire:target="submitComment">
